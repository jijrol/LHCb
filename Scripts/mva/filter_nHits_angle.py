...
f_old_tree = R.TFile.Open("{0}/{1}2tau2pipipi_tree.root".format(treeloc, treename))
old_tree = f_old_tree.Get("DecayTree")

f_filtered_tree = R.TFile.Open("{1}/{0}2tau2pipipi_filtered.root".format(name, treeloc), "RECREATE")
